# graphify-plus — legacy README (pre-v4 architecture)

This file documents an earlier version of graphify-plus that operated as an enhancement layer over [safishamsi/graphify](https://github.com/safishamsi/graphify). The current product is a self-contained tree-sitter-based analyser. See `README.md` for current documentation.

This file is preserved for historical reference only. APIs and modules described below may not exist in the current codebase.
